...
myG4NeutronHPorLEInelastic::myG4NeutronHPorLEInelastic()
...
G4HadFinalState * myG4NeutronHPorLEInelastic::ApplyYourself(const G4HadProjectile& aTrack, G4Nucleus& )
{
   G4int it=0;
...
G4bool myG4NeutronHPorLEInelastic::IsThisElementOK( G4String name )
{
...
void myG4NeutronHPorLEInelastic::createXSectionDataSet()
{
    theDataSet = new G4NeutronHPorLEInelasticData ( theInelastic , &unavailable_elements );
}
const std::pair<G4double, G4double> myG4NeutronHPorLEInelastic::GetFatalEnergyCheckLevels() const
{
