...
myG4NeutronHPorLElastic::myG4NeutronHPorLElastic()
...
G4HadFinalState * myG4NeutronHPorLElastic::ApplyYourself(const G4HadProjectile& aTrack, G4Nucleus& )
{
...
G4bool myG4NeutronHPorLElastic::IsThisElementOK( G4String name )
{
...
void myG4NeutronHPorLElastic::createXSectionDataSet()
{
   theDataSet = new G4NeutronHPorLElasticData ( theElastic , &unavailable_elements );
}

const std::pair<G4double, G4double> myG4NeutronHPorLElastic::GetFatalEnergyCheckLevels() const
{
