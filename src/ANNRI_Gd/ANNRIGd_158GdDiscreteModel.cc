...
ANNRIGd_158GdDiscreteModel::DoGenerate() const
{
	// define relative intensities of discrete transition sequences;
	// ordered by decreasing intensity
	const double p1  = 0.3476;
	const double p2  = 0.1694;  const double sp2  =  p1  + p2;
	const double p3  = 0.0961;  const double sp3  = sp2  + p3;
	const double p4  = 0.0913;  const double sp4  = sp3  + p4;
	const double p5  = 0.0869;  const double sp5  = sp4  + p5;
	const double p6  = 0.0470;  const double sp6  = sp5  + p6;
	const double p7  = 0.0343;  const double sp7  = sp6  + p7;
	const double p8  = 0.0285;  const double sp8  = sp7  + p8;
	const double p9  = 0.0274;  const double sp9  = sp8  + p9;
	const double p10 = 0.0234;  const double sp10 = sp9  + p10;
	const double p11 = 0.0227;  const double sp11 = sp10 + p11;
	const double p12 = 0.0182;  const double sp12 = sp11 + p12;
	const double p13 = 0.0034;  const double sp13 = sp12 + p13;
	const double p14 = 0.0030;  const double sp14 = sp13 + p14;
//	const double p15 = 0.0008;
	...
	if(rndm < p1)        Fill_158Gd_Discrete01(products);
	else if(rndm < sp2)  Fill_158Gd_Discrete02(products);
	else if(rndm < sp3)  Fill_158Gd_Discrete03(products);
	else if(rndm < sp4)  Fill_158Gd_Discrete04(products);
	else if(rndm < sp5)  Fill_158Gd_Discrete05(products);
	else if(rndm < sp6)  Fill_158Gd_Discrete06(products);
	else if(rndm < sp7)  Fill_158Gd_Discrete07(products);
	else if(rndm < sp8)  Fill_158Gd_Discrete08(products);
	else if(rndm < sp9)  Fill_158Gd_Discrete09(products);
	else if(rndm < sp10) Fill_158Gd_Discrete10(products);
	else if(rndm < sp11) Fill_158Gd_Discrete11(products);
	else if(rndm < sp12) Fill_158Gd_Discrete12(products);
	else if(rndm < sp13) Fill_158Gd_Discrete13(products);
	else if(rndm < sp14) Fill_158Gd_Discrete14(products);
	else                 Fill_158Gd_Discrete15(products);
 ...
 */
void
ANNRIGd_158GdDiscreteModel::Fill_158Gd_Discrete01(
		ReactionProductVector& products) const
{
 ...
 */
void
ANNRIGd_158GdDiscreteModel::Fill_158Gd_Discrete02(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_158GdDiscreteModel::Fill_158Gd_Discrete03(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_158GdDiscreteModel::Fill_158Gd_Discrete04(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_158GdDiscreteModel::Fill_158Gd_Discrete05(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_158GdDiscreteModel::Fill_158Gd_Discrete06(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_158GdDiscreteModel::Fill_158Gd_Discrete07(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_158GdDiscreteModel::Fill_158Gd_Discrete08(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_158GdDiscreteModel::Fill_158Gd_Discrete09(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_158GdDiscreteModel::Fill_158Gd_Discrete10(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_158GdDiscreteModel::Fill_158Gd_Discrete11(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_158GdDiscreteModel::Fill_158Gd_Discrete12(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_158GdDiscreteModel::Fill_158Gd_Discrete13(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_158GdDiscreteModel::Fill_158Gd_Discrete14(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_158GdDiscreteModel::Fill_158Gd_Discrete15(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
