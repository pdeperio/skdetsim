...
ANNRIGd_156GdDiscreteModel::DoGenerate() const
{
	// define relative intensities of discrete transition sequences;
	// ordered by decreasing intensity
	const double p1 = 0.0064;
	const double p2 = 0.0838;  const double sp2 =  p1 + p2;
	const double p3 = 0.1628;  const double sp3 = sp2 + p3;
	const double p4 = 0.1266;  const double sp4 = sp3 + p4;
	const double p5 = 0.1163;  const double sp5 = sp4 + p5;
	const double p6 = 0.1088;  const double sp6 = sp5 + p6;
	const double p7 = 0.0338;  const double sp7 = sp6 + p7;
	const double p8 = 0.0733;  const double sp8 = sp7 + p8;
	const double p9 = 0.0627;  const double sp9 = sp8 + p9;
	const double p10 = 0.0674;  const double sp10 = sp9 + p10;
	const double p11 = 0.1029;  const double sp11 = sp10 + p11;
//	const double p12 = 0.0552;  const double sp12 = sp11 + p12;
	...
	if(rndm < p1)       Fill_156Gd_Discrete01(products);
	else if(rndm < sp2) Fill_156Gd_Discrete02(products);
	else if(rndm < sp3) Fill_156Gd_Discrete03(products);
	else if(rndm < sp4) Fill_156Gd_Discrete04(products);
	else if(rndm < sp5) Fill_156Gd_Discrete05(products);
	else if(rndm < sp6) Fill_156Gd_Discrete06(products);
	else if(rndm < sp7) Fill_156Gd_Discrete07(products);
	else if(rndm < sp8) Fill_156Gd_Discrete08(products);
	else if(rndm < sp9) Fill_156Gd_Discrete09(products);
	else if(rndm < sp10) Fill_156Gd_Discrete10(products);
	else if(rndm < sp11) Fill_156Gd_Discrete11(products);
	else                Fill_156Gd_Discrete12(products);
 ...
 */
void
ANNRIGd_156GdDiscreteModel::Fill_156Gd_Discrete01(
 ...
 */
void
ANNRIGd_156GdDiscreteModel::Fill_156Gd_Discrete02(
	ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_156GdDiscreteModel::Fill_156Gd_Discrete03(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_156GdDiscreteModel::Fill_156Gd_Discrete04(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_156GdDiscreteModel::Fill_156Gd_Discrete05(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_156GdDiscreteModel::Fill_156Gd_Discrete06(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_156GdDiscreteModel::Fill_156Gd_Discrete07(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_156GdDiscreteModel::Fill_156Gd_Discrete08(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_156GdDiscreteModel::Fill_156Gd_Discrete09(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_156GdDiscreteModel::Fill_156Gd_Discrete10(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_156GdDiscreteModel::Fill_156Gd_Discrete11(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
 ...
 */
void
ANNRIGd_156GdDiscreteModel::Fill_156Gd_Discrete12(
		ReactionProductVector& products) const
{
	ParticleEnergies energies;
