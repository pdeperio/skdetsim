 ...
 */
void ANNRIGd_GeneratorConfigurator::Configure(
		ANNRIGd_GdNCaptureGammaGenerator& generator, int captureID, int cascadeID,
		...
		const std::string& gd158ContDatFileName)
{
	...
	switch(captureID)
	{
		case 1: // natGd(n,g) reaction - all models needed
			...
			generator.Set156GdContinuumModel(
					new AGd::ANNRIGd_156GdContinuumModelV2(gd156ContDatFileName));
			generator.Set156GdDiscreteModel(
					new AGd::ANNRIGd_156GdDiscreteModel());
			// models for 157Gd(n,g)
			generator.Set158GdContinuumModel(
					new AGd::ANNRIGd_158GdContinuumModelV2(gd158ContDatFileName));
			generator.Set158GdDiscreteModel(
		...
		case 2: // 157Gd(n,g) reaction
			switch(cascadeID)
			{
				case 1: // discrete and continuum
					generator.Set158GdContinuumModel(
							new AGd::ANNRIGd_158GdContinuumModelV2(
									gd158ContDatFileName));
					generator.Set158GdDiscreteModel(
							new AGd::ANNRIGd_158GdDiscreteModel());
					break;
				case 2: // discrete
		...
		case 3: // 155Gd(n,g) reaction
			switch(cascadeID)
			{
				case 1: // discrete and continuum
					generator.Set156GdContinuumModel(
							new AGd::ANNRIGd_156GdContinuumModelV2(
									gd156ContDatFileName));
					generator.Set156GdDiscreteModel(
							new AGd::ANNRIGd_156GdDiscreteModel());
					break;
				case 2: // discrete
