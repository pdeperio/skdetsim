 ...
 */
ANNRIGd_158GdContinuumModelV2& ANNRIGd_158GdContinuumModelV2::operator=(
		const ANNRIGd_158GdContinuumModelV2& other)
{
...
ANNRIGd_158GdContinuumModelV2::DoGenerate() const
{
 ...
 */
void
ANNRIGd_158GdContinuumModelV2::Initialize(const std::string& inDataFileName)
{
