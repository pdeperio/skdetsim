...
#ifndef myG4NeutronHPorLCapture_h
#define myG4NeutronHPorLCapture_h 1
...
class myG4NeutronHPorLCapture : public G4HadronicInteraction
{
  public: 
  
  myG4NeutronHPorLCapture(int gammaModel);
  
  ~myG4NeutronHPorLCapture();
