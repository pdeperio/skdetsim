...
{
  //G4cout<<"***** Using custom gd gamma module with fMODEL = "<<fMODEL<<G4endl;
  ...
  if ( HasFSData() && !G4ParticleHPManager::GetInstance()->GetUseOnlyPhotoEvaporation() && (G4int(theBaseZ)!=64 || fMODEL!=4) ) 
  { //G4cout<<"***** theBaseZ = "<<G4int(theBaseZ)<<" non-photoevaporation model"<<G4endl;
  ...
  { //G4cout<<"***** theBaseZ = "<<G4int(theBaseZ)<<" photoevaporation model"<<G4endl;
