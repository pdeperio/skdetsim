...
#ifndef myG4NeutronHPorLEInelastic_h
#define myG4NeutronHPorLEInelastic_h 1
...
class myG4NeutronHPorLEInelastic : public G4HadronicInteraction
{
  public: 
  
  myG4NeutronHPorLEInelastic();
