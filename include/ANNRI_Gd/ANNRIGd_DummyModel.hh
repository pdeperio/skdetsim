 ...
 */
class ANNRIGd_DummyModel:
		public ANNRIGdGammaSpecModel::ANNRIGd_Model
{
...
inline ANNRIGd_DummyModel* ANNRIGd_DummyModel::Clone() const
{ return DoClone(); }

//______________________________________________________________________________
//! @copydoc ANNRIGd_Model::DpClone() const
inline ANNRIGd_DummyModel* ANNRIGd_DummyModel::DoClone() const
{ return new ANNRIGd_DummyModel(*this); }
