...
inline ANNRIGd_ModelType::ID
ANNRIGd_Model::GetModelTypeID() const { return id_; }
...
ANNRIGd_Model::GetName() const { return name_; }
...
//! @post    Returned raw pointer is not NULL.
//! @return  Raw pointer to a clone of this object.
inline ANNRIGd_Model*
ANNRIGd_Model::Clone() const { return DoClone(); }
...
inline ReactionProductVector
ANNRIGd_Model::Generate() const { return DoGenerate(); }
...
//!         Otherwise false.
inline bool
ANNRIGd_Model::IsDummyModel() const { return id_ == ANNRIGd_ModelType::MdlDummy; }

//______________________________________________________________________________
//! @brief  Checks if the model is a known model.
//! @return True, if the model's type ID is known. Otherwise false.
inline bool
ANNRIGd_Model::IsKnownModel() const { return ANNRIGd_ModelType::IsKnown(id_); }
