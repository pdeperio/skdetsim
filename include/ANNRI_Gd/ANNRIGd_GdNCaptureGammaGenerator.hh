...
namespace ANNRIGdGammaSpecModel { class ANNRIGd_Model; }
...
public: // constructors and destructors
	...
	ANNRIGd_GdNCaptureGammaGenerator(ANNRIGd_Model* mdl156GdCont,
...
inline bool
ANNRIGd_GdNCaptureGammaGenerator::Set156GdContinuumModel(ANNRIGd_Model* model)
...
//! @return True, if the model was set successfully. Otherwise false.
inline bool
ANNRIGd_GdNCaptureGammaGenerator::Set156GdDiscreteModel(ANNRIGd_Model* model)
...
//! @return True, if the model was set successfully. Otherwise false.
inline bool
ANNRIGd_GdNCaptureGammaGenerator::Set158GdContinuumModel(ANNRIGd_Model* model)
...
//! @return True, if the model was set successfully. Otherwise false.
inline bool
ANNRIGd_GdNCaptureGammaGenerator::Set158GdDiscreteModel(ANNRIGd_Model* model)
...
inline bool ANNRIGd_GdNCaptureGammaGenerator::Has156GdContinuumModel() const
{ return CheckModel(gd156ContinuumMdl_); }
...
//! @return  True, if all the checks return true. Otherwise false.
inline bool
ANNRIGd_GdNCaptureGammaGenerator::Has156GdDiscreteModel() const
{ return CheckModel(gd156DiscreteMdl_); }
...
//! @return  True, if all the checks return true. Otherwise false.
inline bool
ANNRIGd_GdNCaptureGammaGenerator::Has158GdContinuumModel() const
{ return CheckModel(gd158ContinuumMdl_); }
...
//! @return  True, if all the checks return true. Otherwise false.
inline bool
ANNRIGd_GdNCaptureGammaGenerator::Has158GdDiscreteModel() const
{ return CheckModel(gd158DiscreteMdl_); }
...
//! @return  True, if all the checks return true. Otherwise false.
inline bool
ANNRIGd_GdNCaptureGammaGenerator::HasAllModels() const
{
	return Has156GdContinuumModel() and
		   Has158GdContinuumModel() and
		   Has156GdDiscreteModel()  and
		   Has158GdDiscreteModel();
}
